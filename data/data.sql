...
INSERT INTO `px_address` (`address_id`, `user_id`, `address_detail`, `address_postalcode`, `address_phone`, `consignee`, `is_default`) VALUES
	('2018110216362745531399', '2018110215571954862401', '上海,普陀,null,真南路625号', '200072', '18217727935', '宫台', 0),
	('2018110216394182783424', '2018110215571954862401', '上海,普陀,null,中江路388号', '200044', '18217727935', '宫台', 1);
...
INSERT INTO `px_brand` (`brand_id`, `brand_name`, `brand_image`, `brand_spell`) VALUES
	('400001', '耐克', '/images/goods/goods/标志制图.jpg', 'naike'),
	('400002', '李宁', '/images/goods/goods/标志制图.jpg', 'lining'),
	('400004', '阿迪达斯', '/images/goods/goods/标志制图.jpg', 'adidasi'),
	('400005', '苹果', '/images/goods/goods/标志制图.jpg', 'apple');
...
-- 正在导出表  shopnet.px_category 的数据：~8 rows (大约)
...
-- 正在导出表  shopnet.px_collect 的数据：~0 rows (大约)
...
-- 正在导出表  shopnet.px_comment 的数据：~0 rows (大约)
...
-- 正在导出表  shopnet.px_discountcoupon 的数据：~0 rows (大约)
...
INSERT INTO `px_goodscolor` (`goodsColor_id`, `goods_id`, `goods_color`, `goods_image`) VALUES
	('2018102613292991403615', '2018102613235684336731', '红色', '/images/goods/goods/标志制图.jpg'),
	('2018102615310142085070', '2018102615125463135465', '灰色', '/images/goods/goods/标志制图.jpg'),
	('2018102915322128713364', '2018102915302169570603', '玫瑰金', '/images/goods/goods/标志制图.jpg');
...
INSERT INTO `px_goodslisting` (`goods_id`, `storage_id`, `category_id`, `style_id`, `brand_id`, `goods_name`, `goods_grounding`, `goods_marketNumber`, `goods_exitNumber`, `goods_market`, `goods_image`, `goods_isRecommend`, `goods_weight`, `goods_marketPrice`, `goods_bid`, `goods_state`) VALUES
	...
	('2018102615125463135465', '200002', '200001', '300001', '400002', '李宁跑鞋', '2018-10-01', 0, 41, '2018-10-02', '/images/goods/goods/标志制图.jpg', 1, 699, 125, 123, 1),
	('2018102915302169570603', '200001', '200002', '300004', '400005', 'iphone x', '2018-10-03', 0, 99, '2018-10-01', '/images/goods/goods/Jellyfish.jpg', 0, 1024, 8888, 6666, 1);
...
INSERT INTO `px_goodssize` (`goodsSize_id`, `goodsColor_id`, `goods_attr`, `goods_number`) VALUES
	('2018102613293522320459', '2018102613292991403615', '帆布', 25),
	('2018102613293850958652', '2018102613292991403615', '塑料', 10),
	('2018102615310118904597', '2018102615310142085070', '牛皮', 33),
	('2018102615310188173382', '2018102615310142085070', '皮革', 8),
	('2018102915323038925606', '2018102915322128713364', '金属材质', 99);
...
-- 正在导出表  shopnet.px_orderdetail 的数据：~1 rows (大约)
...
INSERT INTO `px_orderdetail` (`order_detail_id`, `order_id`, `goods_id`, `goods_number`, `goods_color`, `goods_attr`, `order_detail_isCom`, `is_accept`, `accept_time`) VALUES
	('2018110216404525740243', '2018110216404543365732', '2018102615125463135465', 1, '红色', NULL, 0, 0, NULL);
...
INSERT INTO `px_orders` (`order_id`, `user_id`, `worker_id`, `orderState_id`, `order_phone`, `order_address`, `order_price`, `order_date`, `order_consignee`, `order_postalcode`, `order_payment`, `order_userRequire`, `order_freight`, `order_send`, `order_over`, `jinB_num`) VALUES
	('2018110216404543365732', '2018110215571954862401', NULL, NULL, '18217727935', '上海,普陀,普陀,中江路388号', 259, '2018-11-02 16:40:45', '宫台', '200044', '0', '周六周天派送', 0, NULL, NULL, 0);
...
-- 正在导出表  shopnet.px_secretsecurity 的数据：~0 rows (大约)
...
-- 正在导出表  shopnet.px_shoppingcar 的数据：~0 rows (大约)
...
INSERT INTO `px_style` (`style_id`, `style_name`, `category_id`, `brand_id`) VALUES
	('300001', 'NBA-詹姆斯同款', '200001', '400001'),
	('300002', 'NB-欧文同款', '200001', '400002'),
...
INSERT INTO `px_users` (`user_id`, `user_name`, `user_password`, `user_email`, `user_birthday`, `user_sex`, `user_realName`, `user_address`, `user_telephone`, `is_active`, `check_code`, `email_date`, `jinB`) VALUES
	...
	('2018110215571954862401', 'zhouxianwei', 'dAfN6NiSIX81rQODBPiVzw==', '123@qq.com', NULL, NULL, NULL, NULL, NULL, 0, '90863570', '2018-11-02 15:57:28', 2);
